...
use App\Models\CabezotebomdetalleModel;
use CodeIgniter\RESTful\ResourceController;
class Cabezotebomdetalle extends ResourceController
{
    protected $format    = 'json';
    public function __construct()
    {
        $this->modelName = new CabezotebomdetalleModel();
    }
...
/* fecha de creacion: 09-06-2022 03:02:00 pm */